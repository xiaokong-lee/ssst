(function () {
    ...
    var left = jQuery("div.left");
    var v = function (A) {
        for (var z = jQuery(t).find("li"), x = jQuery(t).width(), y = 0; z[y]; y++, A += 140) {
            z[y].style.cssText = "";
            if (A < 0) {
                z[y].style.marginLeft = (-140 < A ? A : -140) + "px"
            }
            if (A < x && x < A + 140) {
                z[y].style.marginRight = "-140px"
            }
        }
    };
    var g = function (A) {
        ...
        if (A === undefined) {
            ...
            if (z[A].style.marginLeft) {
                ...
                for (var y = 0, x = 140 - jQuery(t).width(); y != A; y++) {
                    x += parseInt(z[y].style.marginLeft || 0) + 140
                }
            }
        }
        return x
    ...
    var p = function (A, z, B, C) {
        ...
        if (D > -1) {
            ...
            if (z) {
                console.log("index",A)
                if(A == "index"){
                    jQuery(t).append('<li index="' + A + '" tab="' + z + '" class="hover">' + z + '</li>');
                }else{
    ...
    var i = function (B) {
        ...
        if (A.length * 140 > jQuery(t).width()) {
        ...
        jQuery(a).css("height", (jQuery(document).height() - 90) + "px")
        jQuery(left).css("height", (jQuery(document).height() - 85) + "px")
    };
    var d = function (y) {
        var x = y.target;
        if (x.tagName == "LI") {
